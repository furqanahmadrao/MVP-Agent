...
-   **TOON Format:** Enable or disable the use of TOON (Token-Oriented Object Notation) format. This can reduce token usage by 30-60%.
-   **Auto-Detect Project Level:** Enable or disable automatic complexity estimation.

## .env File Configuration

You can also configure the application using a `.env` file in the root of the project.
